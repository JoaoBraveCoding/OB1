...
| ------------ | ------------ | ------- |
| [Updating CI for ARM image support](.github/workflows/docker-build-push.yml) | Updating CI for ARM image support. | [@Copilot](https://github.com/Copilot) |
| [Ci: always push Docker image on workflow run](.github/workflows/docker-build-push.yml) | Ci: always push Docker image on workflow run. | [@Copilot](https://github.com/Copilot) |
